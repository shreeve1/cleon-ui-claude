...
import { createClientId, escapeHtml, escapeAttr, formatTimestamp, getShortId } from './utils.js';
import { formatMarkdown } from './markdown.js';
import { setElementHtml, sessionBarEl, sessionTabsEl, abortBtn, chatInput, sendBtn, modeBtn, modelBtn, attachBtn, projectNameEl } from './dom.js';
import { renderActivityStatus, clearMessages, updateScrollFAB, appendMessage, appendToolMessage } from './messages.js';
...
export { createSession, getActiveSession, getSessionByInternalId, getSessionBySessionId, createSessionContainer, renderSessionBar, switchToSession, closeSession, saveSessionState, restoreSessionState, loadSessionHistory };
